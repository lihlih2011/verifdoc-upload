                        ...
                        <div className="py-12 md:py-20">
                            ...
                            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                                ...
                                <div className="relative flex flex-col items-start p-6 bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-800 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group">
                                    ...
                                    <h3 className="text-lg font-bold text-white mb-2 font-nacelle">Audit d'Intégrité du Support</h3>
                                ...
                                <div className="relative flex flex-col items-start p-6 bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-800 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group">
                                    ...
                                    <h3 className="text-lg font-bold text-white mb-2 font-nacelle">Concordance des Données</h3>
                                    <p className="text-gray-400 mb-4 text-sm leading-relaxed">
                                ...
                                <div className="relative flex flex-col items-start p-6 bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-800 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group">
                                    ...
                                    <h3 className="text-lg font-bold text-white mb-2 font-nacelle">Génération de Certificats</h3>
                                    <p className="text-gray-400 mb-4 text-sm leading-relaxed">
                                ...
                                <div className="relative flex flex-col items-start p-6 bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-800 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group">
                                    ...
                                    <h3 className="text-lg font-bold text-white mb-2 font-nacelle">Lutte contre la Fraude Sérielle</h3>
                                    <p className="text-gray-400 mb-4 text-sm leading-relaxed">
                                ...
                                <div className="relative flex flex-col items-start p-6 bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-800 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group">
                                    ...
                                    <h3 className="text-lg font-bold text-white mb-2 font-nacelle">Conformité Réglementaire (KYC/KYB)</h3>
                                    <p className="text-gray-400 mb-4 text-sm leading-relaxed">
                                ...
                                <div className="relative flex flex-col items-start p-6 bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-800 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group">
                                    ...
                                    <h3 className="text-lg font-bold text-white mb-2 font-nacelle">Gouvernance des Données</h3>
                                    <p className="text-gray-400 mb-4 text-sm leading-relaxed">
