    ...
    return (
        <div className="pt-24 min-h-screen bg-[#0B0F17] text-white">
            ...
            <section className="relative px-6 lg:px-8 py-20 overflow-hidden text-center">
                {/* Background FX */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-blue-600/20 rounded-full blur-[120px] pointer-events-none opacity-40 mix-blend-screen -z-10" />
