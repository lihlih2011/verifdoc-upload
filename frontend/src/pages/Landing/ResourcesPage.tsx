                        ...
                        <div className="py-12 md:py-20">
                            ...
                            <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
                                ...
                                <article className="flex flex-col bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-purple-500/10 hover:border-purple-500/30 transition-all duration-300 group">
                                    <div className="h-48 bg-gray-800 flex items-center justify-center text-gray-600 group-hover:bg-gray-800/80 transition-colors">
                                    ...
                                    <div className="p-6 flex flex-col grow">
                                        ...
                                        <h3 className="h4 mb-2 text-xl font-bold font-nacelle">
                                            <a href="#0" className="text-white hover:text-purple-400 transition-colors">Mise à jour des obligations de vigilance</a>
                                        </h3>
                                ...
                                <article className="flex flex-col bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-purple-500/10 hover:border-purple-500/30 transition-all duration-300 group">
                                    ...
                                    <div className="p-6 flex flex-col grow">
                                        ...
                                        <h3 className="h4 mb-2 text-xl font-bold font-nacelle">
                                            <a href="#0" className="text-white hover:text-purple-400 transition-colors">Responsabilité et Faux Documentaire en Banque</a>
                                        </h3>
                                        <p className="text-gray-400 grow text-sm leading-relaxed">
                                ...
                                <article className="flex flex-col bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-purple-500/10 hover:border-purple-500/30 transition-all duration-300 group">
                                    <div className="h-48 bg-purple-900/20 flex items-center justify-center text-purple-400 group-hover:bg-purple-900/30 transition-colors">
                                    ...
                                    <div className="p-6 flex flex-col grow">
                                        ...
                                        <h3 className="h4 mb-2 text-xl font-bold font-nacelle">
                                            <a href="#0" className="text-white hover:text-purple-400 transition-colors">Guide de l'Audit Documentaire 2025</a>
                                        </h3>
                                        <p className="text-gray-400 grow text-sm leading-relaxed">
