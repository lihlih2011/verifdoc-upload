                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    <div className="col-span-1">
                        <div className="flex items-center mb-6">
                            <img src="/images/verifdoc-logo-v3.png" alt="VerifDoc" className="h-16 w-auto transition-all hover:brightness-110 dark:hidden" />
                            <img src="/logo-verifdoc-light.svg" alt="VerifDoc" className="h-10 w-auto transition-all hidden dark:block" />
                        </div>
