        ...
        <footer className="bg-white text-slate-600 text-sm">
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div>
                        <h4 className="font-bold text-slate-900 mb-6 uppercase tracking-wider text-xs">{t('footer.product')}</h4>
                    ...
                    <div>
                        <h4 className="font-bold text-slate-900 mb-6 uppercase tracking-wider text-xs">{t('footer.legal')}</h4>
                        <ul className="space-y-3">
